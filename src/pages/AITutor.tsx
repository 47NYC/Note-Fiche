...
const AITutor = () => {
  return (
    <DashboardLayout>
      <ProGate feature="Tuteur IA avancé" description="Conversations illimitées, modèle plus puissant et réponses contextualisées à partir des fiches de ta classe.">
